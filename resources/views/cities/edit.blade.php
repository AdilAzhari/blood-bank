<x-app-layout>
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit City</h2>
            <form action="{{ route('cities.update', $city->id) }}" method="POST" class="mt-6 space-y-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('cities.index') }}"
                        class="text-gray-600 hover:text-white dark:text-gray-400 dark:hover:text-white">
                        Cancel
                    </a>
                </div>
            </form>
