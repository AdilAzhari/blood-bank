        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('posts.index') }}"
                    ...
                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        ...
                        <path
                            d="M18 0H2a2 2 0 0 0-2 2v15a3 3 0 0 0 3 3h12a1 1 0 0 0 0-2h-1v-2a2 2 0 0 0 2-2ZM4 2h2v12H4V2Zm8 16H3a1 1 0 0 1 0-2h9v2Z" />
                    </svg>
                    <span class="ms-3">Posts</span>
                    {{-- <span class="inline-flex items-center justify-center w-3 h-3 p-2 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span> --}}
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('blood_types.index') }}"
                    ...
                    <span class="ms-3">Blood Type</span>
                </a>
            </li>
            <li>
                <a href="{{ route('clients.index') }}"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap">Clients</span>
                </a>
            </li>
            <li>
                <a href="{{ route('cities.index') }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="w-4 h-4 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 14 10">
                        <path d="M13 5H1m0 0 4 4M1 5l4-4" />
                    </svg>
                    <span class="flex-1 ml-2 whitespace-nowrap">Cities</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ route('governorates.index') }}"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap">Governorates</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('categories.index') }}"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap">Categories</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('donations.index') }}"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap">Donations</span>
                </a>
            </li>
            <li>
                <a href="{{ route('contacts.index') }}"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap">Contacts</span>
                </a>
            </li>
            <li>
                <a href="{{ route('roles.index') }}"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap">Roles</span>
                </a>
            </li>
            <li>
                <a href="{{ route('permissions.index') }}"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap">Permissions</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ route('settings.index') }}"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap">Settings</span>
                </a>
            </li>
    </div>
</div>
