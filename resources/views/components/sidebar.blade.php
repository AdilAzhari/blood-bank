<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform transform bg-gray-50 dark:bg-gray-800 sm:translate-x-0">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('governorates.index') }}"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Governorates</span>
                </a>
            </li>
