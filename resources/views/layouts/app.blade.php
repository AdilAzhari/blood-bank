                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="{{ route('posts.index') }}"
                            ...
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                ...
                                viewBox="0 0 20 20">
                                <path
                                    d="M10 0a1 1 0 0 0-1 1v18a1 1 0 0 0 2 0V1a1 1 0 0 0-1-1Zm8 4a1 1 0 0 0-1 1v14a1 1 0 0 0 2 0V5a1 1 0 0 0-1-1ZM2 16a1 1 0 0 0 1 1h4V3H3a1 1 0 0 0-1 1v12Z" />
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('governorates.index') }}"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">Governorates</span>
                        </a>
                    </li>
                    <li>
